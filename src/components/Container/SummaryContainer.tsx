...
export default function SummaryContainer({ set, kg }: { set: number; kg: number }) {
  return (
    <ContainerStyled>
      <InnerContainerStyled>
        <SubHeadText fontNumber={5}>총 세트</SubHeadText>
        <HeadText fontNumber={2}>{set} set</HeadText>
      </InnerContainerStyled>
      <Blank width={getWidthPixel(70)} />
      <InnerContainerStyled>
        <SubHeadText fontNumber={5}>총 볼륨</SubHeadText>
